...
function midTableMessage(choice) {
	...
	if (choice == 0) { return '<tr class="fulltr"><td class="fulltd">Waiting for a player to pick a card.</tr>' ;}
		...
		outstring = outstring + "<br><br>You may review your draft via the following link.<br><br><a class='pick-history-button' href='pickhistory?player=" + dataDump["my_name"] + '&draftid=' + dataDump['draft_key'] + "'><button class='modobutton'>pick history</button></a></td></tr>";
		return outstring
	}
	else { return '' ;}
}
